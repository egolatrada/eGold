...
module.exports = {
    ...
    async execute(interaction, context) {
        ...
        try {
            ...
            const updatedConfig = await welcomeSystem.updateConfig(interaction.guildId, updates);
            ...
            embed.addFields({
                ...
                value: updatedConfig.enabled 
                    ? '🟢 **Activado**' 
                    : '🔴 **Desactivado** (usa `/bienvenida-activar` para activar)',
                inline: false
            });
